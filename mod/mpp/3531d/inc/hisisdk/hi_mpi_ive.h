 ...
 * Description: definition of hi_mpi_ive.h
 ...
 *
 */
hi_s32 hi_mpi_ive_dma(hi_ive_handle *handle, hi_svp_data *src, hi_svp_dst_data *dst,
    hi_ive_dma_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_filter(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_dst_img *dst,
    hi_ive_filter_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_csc(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_dst_img *dst,
    hi_ive_csc_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_filter_and_csc(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_dst_img *dst,
    hi_ive_filter_and_csc_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_sobel(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_dst_img *dst_h,
    hi_svp_dst_img *dst_v, hi_ive_sobel_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_mag_and_ang(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_dst_img *dst_mag,
    hi_svp_dst_img *dst_ang, hi_ive_mag_and_ang_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_dilate(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_dst_img *dst,
    hi_ive_dilate_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_erode(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_dst_img *dst,
    hi_ive_erode_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_threshold(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_dst_img *dst,
    hi_ive_threshold_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_and(hi_ive_handle *handle, hi_svp_src_img *src1, hi_svp_src_img *src2,
    hi_svp_dst_img *dst, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_sub(hi_ive_handle *handle, hi_svp_src_img *src1, hi_svp_src_img *src2,
    hi_svp_dst_img *dst, hi_ive_sub_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_or(hi_ive_handle *handle, hi_svp_src_img *src1, hi_svp_src_img *src2,
    hi_svp_dst_img *dst, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_integ(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_dst_img *dst,
    hi_ive_integ_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_hist(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_dst_mem_info *dst,
    hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_threshold_s16(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_dst_img *dst,
    hi_ive_threshold_s16_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_threshold_u16(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_dst_img *dst,
    hi_ive_threshold_u16_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_16bit_to_8bit(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_dst_img *dst,
    hi_ive_16bit_to_8bit_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_order_stats_filter(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_dst_img *dst,
    hi_ive_order_stats_filter_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_map(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_src_mem_info *map,
    hi_svp_dst_img *dst, hi_ive_map_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_equalize_hist(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_dst_img *dst,
    hi_ive_equalize_hist_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_add(hi_ive_handle *handle, hi_svp_src_img *src1, hi_svp_src_img *src2,
    hi_svp_dst_img *dst, hi_ive_add_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_xor(hi_ive_handle *handle, hi_svp_src_img *src1, hi_svp_src_img *src2,
    hi_svp_dst_img *dst, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_ncc(hi_ive_handle *handle, hi_svp_src_img *src1, hi_svp_src_img *src2,
    hi_svp_dst_mem_info *dst, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_ccl(hi_ive_handle *handle, hi_svp_img *src_dst, hi_svp_dst_mem_info *blob,
    hi_ive_ccl_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_gmm(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_dst_img *fg,
    hi_svp_dst_img *bg, hi_svp_mem_info *model, hi_ive_gmm_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_gmm2(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_src_img *factor,
    hi_svp_dst_img *fg, hi_svp_dst_img *bg, hi_svp_dst_img *match_model_info,
    hi_svp_mem_info *model, hi_ive_gmm2_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_canny_hys_edge(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_dst_img *edge,
    hi_svp_dst_mem_info *stack, hi_ive_canny_hys_edge_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_canny_edge(hi_svp_img *edge, hi_svp_mem_info *stack);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_lbp(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_dst_img *dst,
    hi_ive_lbp_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_norm_grad(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_dst_img *dst_h,
    hi_svp_dst_img *dst_v, hi_svp_dst_img *dst_hv, hi_ive_norm_grad_ctrl *ctrl, hi_bool is_instant);
 ...
 *                                                                 points in next_points with corresponding poins
 *                                                                 in prev_points.
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_lk_optical_flow_pyr(hi_ive_handle *handle, hi_svp_src_img src_prev_pyr[],
    hi_svp_src_img src_next_pyr[], hi_svp_src_mem_info *prev_points, hi_svp_mem_info *next_points,
    hi_svp_dst_mem_info *status, hi_svp_dst_mem_info *err, hi_ive_lk_optical_flow_pyr_ctrl *ctrl,
    hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_st_cand_corner(hi_ive_handle *handle, hi_svp_src_img *src,
    hi_svp_dst_img *cand_corner, hi_ive_st_cand_corner_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_st_corner(hi_svp_src_img *cand_corner, hi_svp_dst_mem_info *corner,
    hi_ive_st_corner_ctrl *ctrl);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_grad_fg(hi_ive_handle *handle, hi_svp_src_img *bg_diff_fg, hi_svp_src_img *cur_grad,
    hi_svp_src_img *bg_grad, hi_svp_dst_img *grad_fg, hi_ive_grad_fg_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_match_bg_model(hi_ive_handle *handle, hi_svp_src_img *cur_img,
    hi_svp_data *bg_model, hi_svp_img *fg_flag, hi_svp_dst_img *bg_diff_fg, hi_svp_dst_img *frame_diff_fg,
    hi_svp_dst_mem_info *state_data, hi_ive_match_bg_model_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_update_bg_model(hi_ive_handle *handle, hi_svp_data *bg_model, hi_svp_img *fg_flag,
    hi_svp_dst_img *bg_img, hi_svp_dst_img *chg_status_img, hi_svp_dst_img *chg_status_fg,
    hi_svp_dst_img *chg_status_life, hi_svp_dst_mem_info *state_data, hi_ive_update_bg_model_ctrl *ctrl,
    hi_bool is_instant);
 ...
 *
 */
hi_void hi_mpi_ive_ann_mlp_unload_model(hi_ive_ann_mlp_model *model);
 ...
 *                  hi_svp_lut              *actv_func_table         Look-up talbe for active function
 *                  hi_ive_ann_mlp_model    *model                  ANN_MLP model
 *                  hi_svp_dst_data         *dst                    Output layers of every intput sample
 *                  hi_bool                 is_instant              For details, see hi_mpi_ive_dma.
 *   Return Value : HI_SUCCESS: Success;Error codes: Failure.
 *   Date         : 2019-06-30
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_ann_mlp_predict(hi_ive_handle *handle, hi_svp_src_data *src,
    hi_svp_lut *actv_func_table, hi_ive_ann_mlp_model *model, hi_svp_dst_data *dst, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_void hi_mpi_ive_svm_unload_model(hi_ive_svm_model *svm_model);
 ...
 *                  hi_svp_lut              *kernel_table      Look-up talbe for active function
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_svm_predict(hi_ive_handle *handle, hi_svp_src_data *src,
    hi_svp_lut *kernel_table, hi_ive_svm_model *svm_model, hi_svp_dst_data *dst_vote, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_sad(hi_ive_handle *handle, hi_svp_src_img *src1, hi_svp_src_img *src2,
    hi_svp_dst_img *sad, hi_svp_dst_img *threshold, hi_ive_sad_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_resize(hi_ive_handle *handle, hi_svp_src_img src[], hi_svp_dst_img dst[],
    hi_ive_resize_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_void hi_mpi_ive_cnn_unload_model(hi_ive_cnn_model *model);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_cnn_predict(hi_ive_handle *handle, hi_svp_src_img src[], hi_ive_cnn_model *model,
    hi_svp_dst_data *dst, hi_ive_cnn_ctrl *ctrl, hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_cnn_get_result(hi_svp_src_data *src, hi_svp_dst_mem_info *dst,
    hi_ive_cnn_model *model, hi_ive_cnn_ctrl *ctrl);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_persp_trans(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_rect_u32 roi[],
    hi_svp_src_mem_info point_pair[], hi_svp_dst_img dst[], hi_ive_persp_trans_ctrl *ctrl,
    hi_bool is_instant);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_kcf_create_obj_list(hi_svp_mem_info *mem, hi_u32 max_obj_num,
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_kcf_create_gauss_peak(hi_u3q5 padding, hi_svp_dst_mem_info *gauss_peak);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_kcf_create_cos_win(hi_svp_dst_mem_info *cos_win_x, hi_svp_dst_mem_info *cos_win_y);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_kcf_get_train_obj(hi_u3q5 padding, hi_ive_roi_info roi_info[], hi_u32 obj_num,
    hi_svp_mem_info *cos_win_x, hi_svp_mem_info *cos_win_y, hi_svp_mem_info *gauss_peak,
    hi_ive_kcf_obj_list *obj_list);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_kcf_proc(hi_ive_handle *handle, hi_svp_src_img *src,
    hi_ive_kcf_obj_list *obj_list, hi_ive_kcf_proc_ctrl *ctrl, hi_bool is_instant);
...
hi_s32 hi_mpi_ive_kcf_get_obj_bbox(hi_ive_kcf_obj_list *obj_list, hi_ive_kcf_bbox bbox[],
    hi_u32 *bbox_obj_num, hi_ive_kcf_bbox_ctrl *ctrl);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_kcf_judge_obj_bbox_track_state(hi_ive_roi_info *roi_info,
    hi_ive_kcf_bbox *bbox, hi_bool *is_track_ok);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_kcf_obj_update(hi_ive_kcf_obj_list *obj_list, hi_ive_kcf_bbox bbox[],
    hi_u32 bbox_obj_num);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_hog(hi_ive_handle *handle, hi_svp_src_img *src, hi_svp_rect_u32 roi[],
    hi_svp_dst_blob dst[], hi_ive_hog_ctrl *ctrl, hi_bool is_instant);
