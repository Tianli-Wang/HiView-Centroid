...
* Description:define mpi vdec header file
...
hi_s32 hi_mpi_vdec_set_user_data_attr(hi_vdec_chn chn, const hi_vdec_user_data_attr *user_data_attr);
hi_s32 hi_mpi_vdec_get_user_data_attr(hi_vdec_chn chn, hi_vdec_user_data_attr *user_data_attr);
...
#endif /* end of #ifndef  __HI_MPI_VDEC_H__ */
