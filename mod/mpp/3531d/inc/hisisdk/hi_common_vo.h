...
typedef struct {
    hi_bool vo_bypass_en; /* RW, range: [0, 1]; vo bypass enable */
} hi_vo_dev_param;
...
typedef struct {
    ...
    hi_size img_size; /* RW; canvas size of the video layer */
    hi_u32 display_frame_rate; /* RW; display frame rate */
    hi_pixel_format pixel_format; /* RW; pixel format of the video layer */
    hi_bool double_frame_en; /* RW; whether to double frames */
    hi_bool cluster_mode_en; /* RW; whether to take cluster way to use memory */
    hi_dynamic_range dst_dynamic_range; /* RW; video layer output dynamic range type */
    hi_u32 display_buf_len;            /* RW; Video Layer display buffer length */
    hi_vo_partition_mode partition_mode;  /* RW; Video Layer partition mode */
    hi_compress_mode compress_mode; /* RW; Compressing mode */
...
typedef enum  {
    HI_VO_MIRROR_NONE = 0, /* Mirror mode is none */
    HI_VO_MIRROR_HOR  = 1, /* Mirror mode is horizontal mirror */
    HI_VO_MIRROR_VER  = 2, /* Mirror mode is vertical mirror */
    HI_VO_MIRROR_BOTH = 3, /* Mirror mode is horizontal and vertical mirror */
    HI_VO_MIRROR_BUTT
} hi_vo_mirror_mode;
