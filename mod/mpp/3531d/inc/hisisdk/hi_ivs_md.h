 ...
 * Description: definition of hi_ivs_md.h
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_ivs_md_create_chn(hi_md_chn md_chn, hi_md_attr *md_attr);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_ivs_md_set_chn_attr(hi_md_chn md_chn, hi_md_attr *md_attr);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_ivs_md_get_bg(hi_md_chn md_chn, hi_svp_dst_img *bg);
 ...
 *   Author       : Hisilicon multimedia software (SVP) group
 */
hi_s32 hi_ivs_md_proc(hi_md_chn md_chn, hi_svp_src_img *cur, hi_svp_src_img *ref,
    hi_svp_dst_img *sad, hi_svp_dst_mem_info *blob);
