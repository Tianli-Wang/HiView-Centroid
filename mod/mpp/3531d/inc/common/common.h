...
/* typedef struct __file_information
{
    ...
    unsigned int	filepacketnum;			// file packet number = (total size/128bytes), if remain exist, file packet
number++ unsigned char 	onepacketbuf[128+32];
...
typedef enum NC_VIVO_CH_FORMATDEF {
    ...
    AHD20_SD_H960_PAL = 3,  // 960h*576i
    AHD20_SD_SH720_NT,      // 960h*576i
    AHD20_SD_SH720_PAL = 5, // 960h*576i
    AHD20_SD_H1280_NT,
    AHD20_SD_H1280_PAL,
    AHD20_SD_H1440_NT,
    AHD20_SD_H1440_PAL,
    AHD20_SD_H960_EX_NT,       // 1920h*480i
    AHD20_SD_H960_EX_PAL = 11, // 1920h*576i
    AHD20_SD_H960_2EX_NT,
    AHD20_SD_H960_2EX_PAL = 13,
    AHD20_SD_H960_2EX_Btype_NT,       // 3840h*480i
    AHD20_SD_H960_2EX_Btype_PAL = 15, // 3840h*576i
