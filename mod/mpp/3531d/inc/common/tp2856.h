/*
 * Copyright (c) Techpoint Inc. 2017-2020. All rights reserved.
 * Description: Techpoint driver
 * Author: Techpoint Inc.
 * Create: 2020/03/20
...
#define TP2802_SET_AUDIO_RM_FORMAT _IOW(TP2802_IOC_MAGIC, 22, tp2833_audio_format)
#define TP2802_SET_AUDIO_PB_FORMAT _IOW(TP2802_IOC_MAGIC, 23, tp2833_audio_format)
#define TP2830_SET_AUDIO_COAX_CONFIG \
    _IOW(TP2802_IOC_MAGIC, 24, tp2830_audio_coax_config) // Added audio coax configuration - 10/16/2018
#define TP2830_SET_AUDIO_COAX_CHANNEL \
    _IOW(TP2802_IOC_MAGIC, 25, tp2830_audio_coax_channel) // Added audio coax channel selection - 10/16/2018
#define TP2830_GET_AUDIO_COAX_DETECT \
    _IOWR(TP2802_IOC_MAGIC, 26, tp2830_audio_coax_detect) // Added audio coax detection status - 10/16/2018
#endif
