...
HI_S32 SAMPLE_COMM_SYS_GetPicSize(VIDEO_NORM_E enNorm, PIC_SIZE_E enPicSize, SIZE_S* pstSize)
{
    switch (enPicSize)
    {
        ...
        case PIC_5M:      /* 2592 * 1944 */
            ...
            break;
        case PIC_2688x1944:      /* 2592 * 1944 */
            pstSize->u32Width  = 2688;
            pstSize->u32Height = 1944;
            break;
        case PIC_6M:      /* 3072 * 2160 */
            pstSize->u32Width  = 3072;
        ...
        case PIC_UHD4K:   /* 3840 * 2160 */
            ...
            pstSize->u32Height = 2160;
            break;
        case PIC_3Kx3K:   /* 3000 * 3000 */
            pstSize->u32Width  = 3000;
            pstSize->u32Height = 3000;
            break;
		case PIC_12M:   /* 4000 * 3000 */
			pstSize->u32Width  = 4000;
			pstSize->u32Height = 3000;
			break;
		case PIC_16M:   /* 4608 * 3456 */
            pstSize->u32Width  = 4608;
            pstSize->u32Height = 3456;
            break;
        default:
            return HI_FAILURE;
    }
...
HI_S32 SAMPLE_COMM_SYS_Init_With_DCF(VB_CONF_S* pstVbConf, HI_BOOL bIspStat)
{
	...
	if(HI_TRUE == bIspStat)
	{
		stSupplementConf.u32SupplementConf |= VB_SUPPLEMENT_ISPSTAT_MASK;
	}
